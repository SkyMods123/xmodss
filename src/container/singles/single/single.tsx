      ...
      <div className="bg-background __className_3a0388 min-h-screen">
                  ...
                  <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                    ...
                    <div className="p-6 pt-0 space-y-4">
                      <div className="flex flex-col gap-2">
                        <h4 className="text-neutral-900 truncate text-xl font-bold sm:text-2xl dark:text-neutral-100">
                          {content}
                        </h4>
                      </div>
                    </div>
        ...
        <div className={`nc-PageSingle pt-8 lg:pt-16`}>
          <header className="container rounded-xl">
            <div
              className={!hasFeaturedImage && showRightSidebar ? '' : `mx-auto max-w-screen-md`}
            >
