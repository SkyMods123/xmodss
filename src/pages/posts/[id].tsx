const SinglePage = ()=>{
    return(
        <div className="bg-black min-h-screen flex justify-center p-6 px-12">
            <div className="basis-8/12 shadow-lg rounded-lg p-6">
                <div className="bg-[#161b22] border border-[#2f353c] rounded-sm p-3">
                    {/* Header */}
                    <div className="flex justify-between items-center">
                        <h2 className="text-white text-xl font-semibold">Lumin Hub</h2>
                    ...
                    <div className="flex justify-between gap-5">
                        ...
                        <div className="basis-5/12 flex flex-col justify-between mt-3">
                ...
                <div className="bg-[#161b22] text-white border border-[#2f353c] rounded-sm p-3 mt-4">
                    ...
                    <p className="font-bold text-lg mt-2 pl-3">
                        Script Update! Dead Rails 1.0.1 Added Aimbot, Melee Kill Aura, Auto aim & shoot, 
                        Gun Modifications, Auto Heal, No Bandage Delay Use.
                    </p>
            ...
            <div className="basis-4/12 bg-[#161b22] border border-[#2f353c] rounded-sm p-7 mt-5">
